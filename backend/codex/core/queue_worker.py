...
class EventQueueWorker:
    ...
    def _process_event(self, event: FileSystemEvent, session):
        ...
        try:
            ...
            if event.event_type == "move":
                self._handle_move(event, session)
            elif event.event_type == "delete":
                self._handle_delete(event, session)
    ...
    def _handle_move(self, event: FileSystemEvent, session):
    ...
    def _handle_delete(self, event: FileSystemEvent, session):
