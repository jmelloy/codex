...
def upgrade() -> None:
    ...
    if not table_exists("agents"):
        op.create_table(
            ...
            sa.Column("can_execute_code", sa.Boolean(), nullable=False, server_default=sa.text("false")),
            sa.Column("can_access_integrations", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    if not table_exists("agent_action_logs"):
        op.create_table(
            ...
            sa.Column("was_allowed", sa.Boolean(), nullable=False, server_default=sa.text("true")),
