...
def test_list_notebooks(test_client, temp_workspace_dir):
    ...
    test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "My Notebook"},
        headers=headers,
    )

    # List notebooks
    response = test_client.get(
        f"/api/v1/notebooks/?workspace_id={workspace['id']}",
        headers=headers,
    )
...
def test_create_notebook_without_description(test_client, temp_workspace_dir):
    ...
    response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "No Description Notebook"},
        headers=headers,
    )
    assert response.status_code == 200
    data = response.json()
...
def test_create_notebook_generates_slug_path(test_client, temp_workspace_dir):
    ...
    response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "My Special Notebook!"},
        headers=headers,
    )
    assert response.status_code == 200
    data = response.json()
...
def test_create_notebook_handles_name_collision(test_client, temp_workspace_dir):
    ...
    response1 = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "Collision Test"},
        headers=headers,
    )
...
def test_get_notebook_by_id(test_client, temp_workspace_dir):
    ...
    create_response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "Get By ID Test"},
        headers=headers,
    )
    ...
    # Get notebook
    response = test_client.get(
        f"/api/v1/notebooks/{notebook_id}?workspace_id={workspace['id']}",
        headers=headers,
    )
    assert response.status_code == 200
    data = response.json()
...
def test_get_nonexistent_notebook(test_client, temp_workspace_dir):
    ...
    response = test_client.get(
        f"/api/v1/notebooks/99999?workspace_id={workspace['id']}",
        headers=headers,
    )
...
def test_get_notebook_from_other_workspace(test_client, temp_workspace_dir, cleanup_workspaces):
    ...
    create_response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace1["id"], "name": "Private Notebook"},
        headers=headers,
    )
    notebook_id = create_response.json()["id"]
    ...
    response = test_client.get(
        f"/api/v1/notebooks/{notebook_id}?workspace_id={workspace2['id']}",
        headers=headers,
    )
    assert response.status_code == 404
...
def test_list_notebooks_nonexistent_workspace(test_client):
    ...
    response = test_client.get(
        "/api/v1/notebooks/?workspace_id=99999",
        headers=headers,
    )
    assert response.status_code == 404
...
def test_get_notebook_indexing_status(test_client, temp_workspace_dir):
    ...
    create_response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "Indexing Test"},
        headers=headers,
    )
    notebook_id = create_response.json()["id"]
    ...
    # Get indexing status
    response = test_client.get(
        f"/api/v1/notebooks/{notebook_id}/indexing-status?workspace_id={workspace['id']}",
        headers=headers,
    )
    assert response.status_code == 200
    data = response.json()
...
def test_list_notebook_plugins(test_client, temp_workspace_dir):
    ...
    create_response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "Plugin Test"},
        headers=headers,
    )
    notebook_id = create_response.json()["id"]
...
def test_get_notebook_plugin_config(test_client, temp_workspace_dir):
    ...
    create_response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "Plugin Config Test"},
        headers=headers,
    )
    notebook_id = create_response.json()["id"]
...
def test_update_notebook_plugin_config(test_client, temp_workspace_dir):
    ...
    create_response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "Update Plugin Test"},
        headers=headers,
    )
    notebook_id = create_response.json()["id"]
...
def test_update_plugin_config_partial(test_client, temp_workspace_dir):
    ...
    create_response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "Partial Update Test"},
        headers=headers,
    )
    notebook_id = create_response.json()["id"]
...
def test_delete_notebook_plugin_config(test_client, temp_workspace_dir):
    ...
    create_response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "Delete Plugin Test"},
        headers=headers,
    )
    notebook_id = create_response.json()["id"]
...
def test_notebook_requires_authentication(test_client):
    ...
    response = test_client.post("/api/v1/notebooks/", json={"workspace_id": 1, "name": "Test"})
    assert response.status_code == 401

    response = test_client.get("/api/v1/notebooks/1?workspace_id=1")
    assert response.status_code == 401
...
def test_notebook_timestamps(test_client, temp_workspace_dir):
    ...
    response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": workspace["id"], "name": "Timestamp Test"},
        headers=headers,
    )
    assert response.status_code == 200
    data = response.json()
...
def test_create_notebook_in_nonexistent_workspace(test_client):
    ...
    response = test_client.post(
        "/api/v1/notebooks/",
        json={"workspace_id": 99999, "name": "Orphan Notebook"},
        headers=headers,
    )
    assert response.status_code == 404
    assert "Workspace not found" in response.json()["detail"]
